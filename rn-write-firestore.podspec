Pod::Spec.new do |s|
    ...
    s.homepage     = "https://github.com/bennekrouf/rn-firebase-config"
    ...
    s.source       = { :git => "https://github.com/bennekrouf/rn-firebase-config.git", :tag => s.version.to_s }
